...
(function () {
    var BACK, COPLANAR, EPSILON, FRONT, SPANNING, returning, __bind = function (fn, me) { return function () { return fn.apply(me, arguments); }; }, __slice = [].slice, __hasProp = {}.hasOwnProperty, __extends = function (child, parent) { for (var key in parent) {
    ...
    window.ThreeBSP = (function () {
        ...
        ThreeBSP.prototype.toTree = function (treeIsh) {
            var face, geometry, i, polygons, _fn, _i, _len, _ref, _this = this;
        ...
        ThreeBSP.prototype.toGeometry = function () {
            var geometry, matrix, _this = this;
    ...
    ThreeBSP.Polygon = (function () {
        ...
        Polygon.prototype.classifySide = function (polygon) {
            var back, front, tally, v, _i, _len, _ref, _ref1, _this = this;
        ...
        Polygon.prototype.tessellate = function (poly) {
            var b, count, f, i, j, polys, t, ti, tj, v, vi, vj, _i, _len, _ref, _ref1, _ref2, _this = this;
            _ref = {
                f: [],
                b: [],
